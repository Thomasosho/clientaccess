...
export class EditComponent implements OnInit {
  ...
  updateQualification() {
    ...
    this.qualificationForm.value.expertId = this.document.expertId;
    this.crudService.putRequest('api/expertqualification/edit', this.qualificationForm.value).subscribe((res: any) => {
      console.log(res);
      if (res.code === 0) {
