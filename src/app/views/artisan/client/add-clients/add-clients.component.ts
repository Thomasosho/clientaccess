...
export class AddClientsComponent implements OnInit {
  ...
  addClient() {
    ...
    this.clientForm.value.artisanId = Number(this.utilService.getUser());
    this.crudService.postRequest('api/artisanpastclient/add', this.clientForm.value).subscribe((res: any) => {
      console.log(res);
      if (res.code === 0) {
