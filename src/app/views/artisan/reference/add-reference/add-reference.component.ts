...
export class AddReferenceComponent implements OnInit {
  ...
  addReferee() {
    ...
    this.refereeForm.value.artisanId = Number(this.utilService.getUser());
    this.crudService.postRequest('api/artisanreferences/add', this.refereeForm.value).subscribe((res: any) => {
      console.log(res);
      if (res.code === 0) {
